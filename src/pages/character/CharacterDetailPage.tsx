  ...
  return (
    <>
      ...
      <div className='flex flex-col gap-4 w-full mb-1'>
        ...
        <div className='flex sm:flex-row flex-col gap-4'>
          {/* chat */}
          <div className="relative bg-white p-6 rounded-lg border border-[#e5e7eb] sm:w-[440px] w-full h-[635px]" style={{overflowY: 'hidden'}}>
            {/* Heading */}
            <div className="-mx-6 px-6 flex flex-col space-y-1.5 pb-6">
                  ...
                  message.user === "{{user1}}" || message.user === "You" ? (
                    ...
                    <div key={messageIndex} className="flex gap-3 my-4 text-gray-600 text-sm flex-1">
                      ...
                      <div className="leading-relaxed">
                        ...
                        <div className='bg-gray-200 p-4 rounded-b-lg rounded-tr-lg'>
                    ...
                    // Chat Message AI
                    <div key={messageIndex} className="flex flex-row-reverse gap-3 my-4 text-gray-600 text-sm flex-1">
                      <span className="relative flex shrink-0 overflow-hidden rounded-full w-8 h-8">
                        <div className="rounded-full bg-gray-100 border p-1">
                      ...
                      <div key={messageIndex} className="leading-relaxed">
                        ...
                        <div className='bg-gray-200 p-4 rounded-b-lg rounded-tl-lg'>
                          {message.content.text}
                        </div>
                      </div>
                    </div>
